...
username="victoria"
password="victoriapasswd"
database="victoriadatabase"
...
#Go to the www folder and clone the laravel directory
cd /var/www
...
#edit .env file
# Define new database parameters
db_name="victoriadatabase"
db_user="victoria"
db_pass="victoriapasswd"
db_host="localhost"
db_port="3309"
...
# Disable default site and reload Apache
sudo a2dissite 000-default.conf
sudo systemctl reload apache2

# Enable Laravel Site and Reload Apache2
sudo a2ensite laravel-php.conf
sudo systemctl reload apache2
vagrant@Master:~$ ls
ansible  nano.save  script.sh  script.sh.save
vagrant@Master:~$ cat script.sh
#!/bin/bash
